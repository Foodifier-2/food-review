...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('reviews') // Will print the overall rating average, as well as the specified numebr of reviews, with their corresponding ratings.
        .setDescription('Get a list of reviews for the specified food item,') // option of todays reviews 
